...
La infraestructura es un **componente cristalizado del ecosistema [[Bildung]] que no solo genera valor — modifica la capacidad del sistema para generar valor**. Es un multiplicador de segundo orden: mientras un [[Activo]] produce output, la infraestructura **altera las reglas, los flujos y las conexiones** que determinan qué puede producirse.
...
4. **Habilita experimentos**: la infraestructura reduce la [[Fricción Sistémica]] de iniciar nuevos experimentos. Un entorno de desarrollo bien configurado no es un activo — pero sin él, cada experimento nuevo cuesta el doble.
...
| **Cognitiva** | [[Codex Bildung\|Codex]], Ontología, metodologías de modelado | Resolución con que se observa el sistema |
...
En el gradiente de resolución del [[Laboratorio Bildung|Laboratorio]], la infraestructura ocupa el nivel 5 — un paso más allá del activo:
...
- [[Activo]] — el concepto del que se distingue; un mismo proyecto puede ser ambos
- [[Laboratorio Bildung]] — el ecosistema que la infraestructura modifica
- [[Cristalización]] — el proceso por el cual un experimento se convierte en infraestructura
- [[Codex Bildung]] — el caso más extremo de infraestructura cognitiva: emergió del Lab y ahora reescribe sus reglas
- [[Fricción Sistémica]] — lo que la infraestructura reduce sistémicamente
- [[Gobernanza Adaptativa]] — decide qué infraestructura se mantiene, qué se composta
- [[Normalización]] — la infraestructura cognitiva requiere normalización previa
